 ...
 * @param <T>
 */
public interface AbstractProductWarehouseAttrService <T extends Serializable> extends GenericService<T> {
 
    public List<T> getByProductWarehouse(ProductWarehouse productWarehouse);
}