...
package org.production.business.security.provider;
...
public class UserDetailsServiceImpl implements org.springframework.security.core.userdetails.UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String userName)
        ...
        org.production.business.domain.User user = (org.production.business.domain.User) userService.findByUserName(userName);
        if (user != null) {
