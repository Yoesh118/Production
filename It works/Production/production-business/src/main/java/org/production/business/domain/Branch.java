...
@XmlRootElement
public class Branch extends BaseMetaData implements Serializable {
    ...
    public Branch(String districtId) {
        this.districtId = districtId;
    }

    public Branch(String districtId, String name, Date dateCreated) {
        this.districtId = districtId;
        super.setName(name);
    ...
    public boolean equals(Object obj) {
        ...
        return this.getDistrictId().equals(((Branch) obj).getDistrictId());
    }
