 ...
 * @param <T>
 */
public interface AbstractProcessingPlantAttrService <T extends Serializable> extends GenericService<T> {
 
    public List<T> getByProcessingPlant(ProcessingPlant processingPlant);
}