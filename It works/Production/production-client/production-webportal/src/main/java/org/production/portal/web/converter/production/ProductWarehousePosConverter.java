 ...
 */
public class ProductWarehousePosConverter implements Converter<String, ProductWarehousePos> {
    
    @Resource
    private ProductWarehousePosService productWarehousePosService;

    @Override
    public ProductWarehousePos convert(String s) {
        if(s.equals("")) return null;
        return productWarehousePosService.get(String.valueOf(s));
    }
