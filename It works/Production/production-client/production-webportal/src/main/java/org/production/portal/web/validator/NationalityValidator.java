...
public class NationalityValidator implements Validator {
    ...
    public boolean supports(Class<?> type) {
        return Nationality.class.equals(type);
    }
    ...
    public void validate(Object o, Errors errors) {
        ...
        /**
         * @param name nationality name must always be unique
         */
        Nationality current = (Nationality) o;
      
        /**
         * currently no nationalitys with less than three characters so we start @
         * 4
         */
