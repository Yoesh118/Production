 ...
 */
public class CompanyContactConverter implements Converter<String, CompanyContact> {
    
    @Resource
    private CompanyContactService companyContactService;

    @Override
    public CompanyContact convert(String s) {
        if(s.equals("")) return null;
        return companyContactService.get(String.valueOf(s));
    }
