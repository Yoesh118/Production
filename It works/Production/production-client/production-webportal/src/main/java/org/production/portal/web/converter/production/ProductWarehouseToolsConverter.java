 ...
 */
public class ProductWarehouseToolsConverter implements Converter<String, ProductWarehouseTools> {
    
    @Resource
    private ProductWarehouseToolsService productWarehouseToolsService;

    @Override
    public ProductWarehouseTools convert(String s) {
        if(s.equals("")) return null;
        return productWarehouseToolsService.get(String.valueOf(s));
    }
