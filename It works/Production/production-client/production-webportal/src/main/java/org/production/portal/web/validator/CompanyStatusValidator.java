 ...
 */
@Component
public class CompanyStatusValidator implements Validator {

    

    @Override
    public boolean supports(Class<?> type) {
        return CompanyStatus.class.equals(type);
    }
    ...
    public void validate(Object o, Errors errors) {
        ...
        /**
         * @param name companyStatus name must always be unique
         */
        CompanyStatus current = (CompanyStatus) o;
      
        /**
         * currently no companyStatuss with less than three characters so we start @
         * 4
         */
