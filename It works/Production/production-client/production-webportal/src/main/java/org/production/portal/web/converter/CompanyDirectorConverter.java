 ...
 */
public class CompanyDirectorConverter implements Converter<String, CompanyDirector> {
    
    @Resource
    private CompanyDirectorService companyDirectorService;

    @Override
    public CompanyDirector convert(String s) {
        if(s.equals("")) return null;
        return companyDirectorService.get(String.valueOf(s));
    }
