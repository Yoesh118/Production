 ...
 */
public class ClientMaintananceConverter implements Converter<String, ClientMaintanance> {
    
    @Resource
    private ClientMaintananceService clientMaintananceService;

    @Override
    public ClientMaintanance convert(String s) {
        if(s.equals("")) return null;
        return clientMaintananceService.get(String.valueOf(s));
    }
