 ...
 */
public class IncidentCostConverter implements Converter<String, IncidentCost> {
    
    @Resource
    private IncidentCostService incidentCostService;

    @Override
    public IncidentCost convert(String s) {
        if(s.equals("")) return null;
        return incidentCostService.get(String.valueOf(s));
    }
