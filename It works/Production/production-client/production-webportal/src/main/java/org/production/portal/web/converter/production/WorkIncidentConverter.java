 ...
 */
public class WorkIncidentConverter implements Converter<String, WorkIncident> {
    
    @Resource
    private WorkIncidentService workIncidentService;

    @Override
    public WorkIncident convert(String s) {
        if(s.equals("")) return null;
        return workIncidentService.get(String.valueOf(s));
    }
