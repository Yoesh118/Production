 ...
 */
public class AssetMaintananceConverter implements Converter<String, AssetMaintanance> {
    
    @Resource
    private AssetMaintananceService assetMaintananceService;

    @Override
    public AssetMaintanance convert(String s) {
        if(s.equals("")) return null;
        return assetMaintananceService.get(String.valueOf(s));
    }
