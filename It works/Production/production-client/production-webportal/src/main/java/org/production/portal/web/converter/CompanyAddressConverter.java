 ...
 */
public class CompanyAddressConverter implements Converter<String, CompanyAddress> {
    
    @Resource
    private CompanyAddressService companyAddressService;

    @Override
    public CompanyAddress convert(String s) {
        if(s.equals("")) return null;
        return companyAddressService.get(String.valueOf(s));
    }
