 ...
 */
public class ProcessingPlantMachineryConverter implements Converter<String, ProcessingPlantMachinery> {
    
    @Resource
    private ProcessingPlantMachineryService processingPlantMachineryService;

    @Override
    public ProcessingPlantMachinery convert(String s) {
        if(s.equals("")) return null;
        return processingPlantMachineryService.get(String.valueOf(s));
    }
