 ...
 */
public class ProcurementCostConverter implements Converter<String, ProcurementCost> {
    
    @Resource
    private ProcurementCostService procurementCostService;

    @Override
    public ProcurementCost convert(String s) {
        if(s.equals("")) return null;
        return procurementCostService.get(String.valueOf(s));
    }
