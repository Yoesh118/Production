 ...
 */
public class BatchStatusConverter implements Converter<String, BatchStatus> {
    
    @Resource
    private BatchStatusService batchStatusService;

    @Override
    public BatchStatus convert(String s) {
        if(s.equals("")) return null;
        return batchStatusService.get(String.valueOf(s));
    }
