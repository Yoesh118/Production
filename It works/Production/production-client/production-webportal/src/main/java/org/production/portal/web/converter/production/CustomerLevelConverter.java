 ...
 */
public class CustomerLevelConverter implements Converter<String, CustomerLevel> {
    
    @Resource
    private CustomerLevelService customerLevelService;

    @Override
    public CustomerLevel convert(String s) {
        if(s.equals("")) return null;
        return customerLevelService.get(String.valueOf(s));
    }
