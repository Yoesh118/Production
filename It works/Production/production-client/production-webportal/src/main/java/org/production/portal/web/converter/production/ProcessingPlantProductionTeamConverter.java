 ...
 */
public class ProcessingPlantProductionTeamConverter implements Converter<String, ProcessingPlantProductionTeam> {
    
    @Resource
    private ProcessingPlantProductionTeamService processingPlantProductionTeamService;

    @Override
    public ProcessingPlantProductionTeam convert(String s) {
        if(s.equals("")) return null;
        return processingPlantProductionTeamService.get(String.valueOf(s));
    }
