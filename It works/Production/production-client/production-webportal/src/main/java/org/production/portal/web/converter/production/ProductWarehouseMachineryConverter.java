 ...
 */
public class ProductWarehouseMachineryConverter implements Converter<String, ProductWarehouseMachinery> {
    
    @Resource
    private ProductWarehouseMachineryService productWarehouseMachineryService;

    @Override
    public ProductWarehouseMachinery convert(String s) {
        if(s.equals("")) return null;
        return productWarehouseMachineryService.get(String.valueOf(s));
    }
