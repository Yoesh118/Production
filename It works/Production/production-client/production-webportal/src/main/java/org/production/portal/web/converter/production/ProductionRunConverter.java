 ...
 */
public class ProductionRunConverter implements Converter<String, ProductionRun> {
    
    @Resource
    private ProductionRunService productionRunService;

    @Override
    public ProductionRun convert(String s) {
        if(s.equals("")) return null;
        return productionRunService.get(String.valueOf(s));
    }
