 ...
 */
public class FinishedProductsConverter implements Converter<String, FinishedProducts> {
    
    @Resource
    private FinishedProductsService finishedProductsService;

    @Override
    public FinishedProducts convert(String s) {
        if(s.equals("")) return null;
        return finishedProductsService.get(String.valueOf(s));
    }
