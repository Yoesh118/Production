 ...
 */
public class ProcessingPlantMaterialConverter implements Converter<String, ProcessingPlantMaterial> {
    
    @Resource
    private ProcessingPlantMaterialService processingPlantMaterialService;

    @Override
    public ProcessingPlantMaterial convert(String s) {
        if(s.equals("")) return null;
        return processingPlantMaterialService.get(String.valueOf(s));
    }
