 ...
 */
public class ProductWarehouseConverter implements Converter<String, ProductWarehouse> {
    
    @Resource
    private ProductWarehouseService productWarehouseService;

    @Override
    public ProductWarehouse convert(String s) {
        if(s.equals("")) return null;
        return productWarehouseService.get(String.valueOf(s));
    }
