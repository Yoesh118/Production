 ...
 */
public class SupportingDocumentConverter implements Converter<String, SupportingDocument> {
    
    @Resource
    private SupportingDocumentService supportingDocumentService;

    @Override
    public SupportingDocument convert(String s) {
        if(s.equals("")) return null;
        return supportingDocumentService.get(String.valueOf(s));
    }
