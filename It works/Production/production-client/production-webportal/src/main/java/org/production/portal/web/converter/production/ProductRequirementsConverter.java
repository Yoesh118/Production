 ...
 */
public class ProductRequirementsConverter implements Converter<String, ProductRequirements> {
    
    @Resource
    private ProductRequirementsService productRequirementsService;

    @Override
    public ProductRequirements convert(String s) {
        if(s.equals("")) return null;
        return productRequirementsService.get(String.valueOf(s));
    }
