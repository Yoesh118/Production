 ...
 */
public class ProcessPlanConverter implements Converter<String, ProcessPlan> {
    
    @Resource
    private ProcessPlanService processPlanService;

    @Override
    public ProcessPlan convert(String s) {
        if(s.equals("")) return null;
        return processPlanService.get(String.valueOf(s));
    }
