...
public class CapacityPlanConverter implements Converter<String, CapacityPlan> {
    
    @Resource
    private CapacityPlanService capacityPlanService;

    @Override
    public CapacityPlan convert(String s) {
        if(s.equals("")) return null;
        return capacityPlanService.get(String.valueOf(s));
    }
