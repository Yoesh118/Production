 ...
 */
public class ProductionTeamConverter implements Converter<String, ProductionTeam> {
    
    @Resource
    private ProductionTeamService productionTeamService;

    @Override
    public ProductionTeam convert(String s) {
        if(s.equals("")) return null;
        return productionTeamService.get(String.valueOf(s));
    }
