 ...
 */
public class ProductBatchConverter implements Converter<String, ProductBatch> {
    
    @Resource
    private ProductBatchService productBatchService;

    @Override
    public ProductBatch convert(String s) {
        if(s.equals("")) return null;
        return productBatchService.get(String.valueOf(s));
    }
